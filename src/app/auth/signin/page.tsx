...
function SignInContent() {
  ...
  const demoEmail = searchParams.get('email') || 'demo@stash.app'

  // Auto-connexion en mode démo
  useEffect(() => {
    if (isDemo) {
      const autoSignIn = async () => {
        ...
        try {
          ...
          if (result?.error) {
            console.error('Erreur connexion démo:', result.error)
          ...
          toast.error('Une erreur est survenue lors de la connexion démo')
          setIsDemoLoading(false)
        }
      }
              ...
              {isDemo ? (
                <div className="text-center py-8">
                  <div className="space-y-3">
                    ...
                    <div>
                      <h2 className="text-lg font-semibold mb-1">Mode Démo</h2>
                      <p className="text-sm text-muted-foreground">Connexion automatique en cours...</p>
                    </div>
                  </div>
                </div>
              ) : (
                <div className="space-y-4">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <Link href="/auth/forgot-password" className="text-xs text-primary hover:underline cursor-pointer">
                        Mot de passe oublié ?
                      </Link>
                    </div>

                    <Button type="submit" className="w-full h-9 cursor-pointer" disabled={isLoading}>
